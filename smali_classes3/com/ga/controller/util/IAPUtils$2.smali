.class Lcom/ga/controller/util/IAPUtils$2;
...
.method constructor <init>(Lcom/ga/controller/util/IAPUtils;Lcom/ga/controller/util/IAPUtils$onResult;Ljava/text/NumberFormat;)V
    ...
    .line 79
    iput-object p1, p0, Lcom/ga/controller/util/IAPUtils$2;->this$0:Lcom/ga/controller/util/IAPUtils;

    iput-object p2, p0, Lcom/ga/controller/util/IAPUtils$2;->val$mOnResult:Lcom/ga/controller/util/IAPUtils$onResult;

    iput-object p3, p0, Lcom/ga/controller/util/IAPUtils$2;->val$numberFormat:Ljava/text/NumberFormat;
...
.method public onSkuDetailsError(Ljava/lang/String;)V
    ...
    .line 93
    iget-object p1, p0, Lcom/ga/controller/util/IAPUtils$2;->val$mOnResult:Lcom/ga/controller/util/IAPUtils$onResult;
    ...
    .line 94
    invoke-interface {p1, v0}, Lcom/ga/controller/util/IAPUtils$onResult;->onPriceMonth(Ljava/lang/String;)V
...
.method public onSkuDetailsResponse(Ljava/util/List;)V
    ...
    .line 84
    iget-object v1, p0, Lcom/ga/controller/util/IAPUtils$2;->val$mOnResult:Lcom/ga/controller/util/IAPUtils$onResult;

    if-eqz v1, :cond_0

    .line 85
    iget-object v2, p0, Lcom/ga/controller/util/IAPUtils$2;->val$numberFormat:Ljava/text/NumberFormat;
    ...
    invoke-interface {v1, v2}, Lcom/ga/controller/util/IAPUtils$onResult;->onPriceMonth(Ljava/lang/String;)V
