...
# direct methods
.method private static synthetic $values()[Lgateway/v1/ClientInfoOuterClass$MediationProvider;
    .locals 3

    const/4 v0, 0x6

    new-array v0, v0, [Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    const/4 v1, 0x0

    .line 112
    sget-object v2, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_UNSPECIFIED:Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_CUSTOM:Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    sget-object v2, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_ADMOB:Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    sget-object v2, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_MAX:Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    aput-object v2, v0, v1

    const/4 v1, 0x4

    sget-object v2, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_LEVELPLAY:Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    aput-object v2, v0, v1

    const/4 v1, 0x5

    sget-object v2, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->UNRECOGNIZED:Lgateway/v1/ClientInfoOuterClass$MediationProvider;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_CUSTOM:Lgateway/v1/ClientInfoOuterClass$MediationProvider;
    ...
    sput-object v0, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_ADMOB:Lgateway/v1/ClientInfoOuterClass$MediationProvider;
    ...
    sput-object v0, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_MAX:Lgateway/v1/ClientInfoOuterClass$MediationProvider;
    ...
    sput-object v0, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->MEDIATION_PROVIDER_LEVELPLAY:Lgateway/v1/ClientInfoOuterClass$MediationProvider;
    ...
    invoke-direct {v0, v3, v1, v2}, Lgateway/v1/ClientInfoOuterClass$MediationProvider;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->UNRECOGNIZED:Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    .line 112
    invoke-static {}, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->$values()[Lgateway/v1/ClientInfoOuterClass$MediationProvider;

    move-result-object v0

    sput-object v0, Lgateway/v1/ClientInfoOuterClass$MediationProvider;->$VALUES:[Lgateway/v1/ClientInfoOuterClass$MediationProvider;
