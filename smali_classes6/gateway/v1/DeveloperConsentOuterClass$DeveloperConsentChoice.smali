...
# direct methods
.method private static synthetic $values()[Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;
    .locals 3

    const/4 v0, 0x4

    new-array v0, v0, [Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;

    const/4 v1, 0x0

    .line 188
    sget-object v2, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->DEVELOPER_CONSENT_CHOICE_UNSPECIFIED:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->DEVELOPER_CONSENT_CHOICE_TRUE:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    sget-object v2, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->DEVELOPER_CONSENT_CHOICE_FALSE:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    sget-object v2, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->UNRECOGNIZED:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->DEVELOPER_CONSENT_CHOICE_TRUE:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;
    ...
    sput-object v0, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->DEVELOPER_CONSENT_CHOICE_FALSE:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;
    ...
    invoke-direct {v0, v3, v1, v2}, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->UNRECOGNIZED:Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;

    .line 188
    invoke-static {}, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->$values()[Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;

    move-result-object v0

    sput-object v0, Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;->$VALUES:[Lgateway/v1/DeveloperConsentOuterClass$DeveloperConsentChoice;
